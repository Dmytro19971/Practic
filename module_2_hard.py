...
n = int(input('Enter of cipher: '))
print('Password :', get_passcode(n))


pairnumbers_1 = list(range(1, n))
pairnumbers_2 = list(range(1, n))
pairs = []
result = ''

for i in pairnumbers_1:
    for j in pairnumbers_2:
        pn1 = i
        pn2 = j
        if pn1 >= pn2:
            continue
...
print('Enter password', result,)
if int(result) == get_passcode(n):
    print('The way is free!')